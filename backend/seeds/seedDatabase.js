...
const seedUsers = async () => {
  ...
  const users = [
    ...
    },
    {
      ...
      isActive: true,
      permissions: ['inventory_manage', 'reports_view', 'analytics_view']
    },
    {
      name: 'Staff User',
...
const seedApiKeys = async (users) => {
  ...
  const apiKeys = [
    ...
    },
    {
      ...
      key: 'sk_live_analytics_' + require('crypto').randomBytes(32).toString('hex'),
    ...
    },
    {
      ...
      key: 'sk_live_readonly_' + require('crypto').randomBytes(32).toString('hex'),
      permissions: ['read'],
      rateLimit: 1000,
      createdBy: superAdmin._id
    }
